package org.firstinspires.ftc.teamcode.tdt.commands.Autonomous.Pathing.DriveCommands;
...
public class DriveForward extends CommandBase {
    ...
    public void execute() {
        ...
        double drive = driveTrain.driveController.getOutput(driveTrain.tl.getCurrPosInches() , distance);
        ...
        if(Math.abs(driveTrain.driveController.getError()) <= 2){
